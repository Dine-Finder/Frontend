...
import RestuarantPanel from "./RestuarantPanel";
...
export default function UserMap() {
  ...
  const maxPage =
    Math.floor(numberOfBusinesses / numberOfRestuarants) +
    Math.ceil((numberOfBusinesses % numberOfRestuarants) / numberOfRestuarants);
  const currentPage = Math.min(
    numberOfRestuarants,
    numberOfBusinesses - (pageNumber - 1) * numberOfRestuarants
  );
  ...
  function handleNumberOfRestuarants(buttonNumber) {
    if (selectedRestuarant === null) {
      setPageNumber(
        Math.ceil(((pageNumber - 1) * numberOfRestuarants + 1) / buttonNumber)
      );
    } else {
    ...
    <div className="h-[100vh]">
      ...
      >
        <SideBox
          ...
          confirmFilter={sendDataToBackend}
        />
          ...
          <RecommendationBox>
            {Array.from({ length: currentPage }, (_, index) => (
              <RestuarantPanel
                ...
                ranking={index + 1}
                info={businesses}
                showing={numberOfRestuarants}
                page={pageNumber}
                onClick={() =>
                  handleSelectedRestuarant(
                    index + numberOfRestuarants * (pageNumber - 1) + 1
                  )
                }
              />
            ))}
          ...
          >
            ...
            >
                ...
                {maxPage <= 5 ? (
                  Array.from({ length: maxPage - 1 }, (_, index) => (
                    <PageButton
                      key={index + 2}
                      pageNumber={pageNumber}
                      buttonNumber={index + 2}
                      onClick={() => handlePageButtonClick(index + 2)}
                    />
                  ))
                ) : (
                  <>
                    <PageButton
                      key={2}
                      pageNumber={pageNumber}
                      buttonNumber={Math.min(
                        Math.max(2, pageNumber - 1),
                        maxPage - 3
                      )}
                      onClick={() =>
                        handlePageButtonClick(
                          Math.min(Math.max(2, pageNumber - 1), maxPage - 3)
                        )
                      }
                    />
                    <PageButton
                      ...
                      onClick={() =>
                        handlePageButtonClick(
                          Math.min(Math.max(3, pageNumber), maxPage - 2)
                        )
                      }
                    />
                    <PageButton
                      ...
                      onClick={() =>
                        handlePageButtonClick(
                          Math.min(Math.max(4, pageNumber + 1), maxPage - 1)
                        )
                      }
                    />
                    <PageButton
                      ...
                      pageNumber={pageNumber}
                      buttonNumber={Math.min(
                        Math.max(5, pageNumber + 5),
                        maxPage
                      )}
                      onClick={() =>
                        handlePageButtonClick(
                          Math.max(
                            Math.min(Math.max(5, pageNumber + 5), maxPage)
                          )
                        )
                      }
                    />
              ...
              <PerPageButton
                key={1}
                buttonNumber={20}
                onClick={() => handleNumberOfRestuarants(20)}
                numberOfRestuarants={numberOfRestuarants}
              />
              <PerPageButton
                key={2}
                buttonNumber={10}
                onClick={() => handleNumberOfRestuarants(10)}
                numberOfRestuarants={numberOfRestuarants}
              />
              <PerPageButton
                key={3}
                buttonNumber={5}
                onClick={() => handleNumberOfRestuarants(5)}
                numberOfRestuarants={numberOfRestuarants}
              />
            </div>
          </div>
